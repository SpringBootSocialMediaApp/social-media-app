...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    Page<User> searchUsers(@Param("currentUserId") Long currentUserId, @Param("searchTerm") String searchTerm, Pageable pageable);
    ...
    @Query("SELECT u FROM User u WHERE u.id <> :currentUserId " +
           ...
           "     ELSE 5 END")
    List<User> searchUsersWithRelevance(@Param("currentUserId") Long currentUserId, @Param("searchTerm") String searchTerm);
}